...
export default function TermsPage() {
  return (
    <LegalPageLayout
      eyebrow="Legal"
      title="Terms"
      intro="These Terms explain the rules for using UBEYE, including accounts, user content, creator and user revenue-share features, advertisers, payments, and moderation."
