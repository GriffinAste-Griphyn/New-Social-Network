      ...
      <main className="overflow-hidden">
        ...
        <section id="premise" className="border-b border-white/10 bg-[#060606]">
          <div className="mx-auto max-w-[1180px] px-4 py-20 md:py-28">
            <div className="grid gap-12 lg:grid-cols-[18rem_minmax(0,1fr)] lg:gap-16">
              <div>
                <p className="text-xs font-medium uppercase text-[#e01616]">The premise</p>
              </div>
              <div>
                <h2 className="max-w-4xl text-4xl font-[350] leading-tight text-white md:text-6xl md:leading-[1.02]">
                ...
                <div className="mt-12 grid gap-4 md:grid-cols-2">
                  {premiseRows.map((row) => (
                    <article key={row.label} className="border border-white/10 bg-white/[0.03] p-5">
                      <p className="text-xs font-medium uppercase text-white/36">{row.label}</p>
                      <h3 className="mt-5 text-2xl font-[350] leading-tight text-white">
                        {row.title}
                      </h3>
          ...
          <div className="mx-auto max-w-[1180px] px-4 py-20 md:py-28">
            <div className="grid gap-12 lg:grid-cols-[minmax(0,0.72fr)_minmax(0,1.28fr)] lg:gap-20">
              <div className="max-w-[28rem]">
                <p className="text-xs font-medium uppercase text-[#e01616]">Setup</p>
                <h2 className="mt-5 text-4xl font-[350] leading-tight text-white md:text-6xl md:leading-[1.02]">
                ...
                {setupSteps.map((step) => (
                  <article key={step.title} className="border border-white/10 bg-[#060606] p-5 md:p-6">
                    <div className="grid gap-5 sm:grid-cols-[3rem_1fr]">
                      ...
                      <div>
                        <p className="text-xs font-medium uppercase text-white/36">{step.label}</p>
                        <h3 className="mt-2 text-2xl font-[350] leading-tight text-white">
                          {step.title}
                        </h3>
        ...
        <section id="controls" className="border-b border-white/10 bg-[#060606]">
          <div className="mx-auto grid max-w-[1180px] gap-12 px-4 py-20 md:py-28 lg:grid-cols-[minmax(0,1fr)_28rem] lg:items-start">
            <div>
              <p className="text-xs font-medium uppercase text-[#e01616]">Controls</p>
              <h2 className="mt-5 max-w-4xl text-4xl font-[350] leading-tight text-white md:text-6xl md:leading-[1.02]">
            ...
            <div className="border border-white/12 bg-black/54 p-5 text-white">
              <p className="inline-flex items-center gap-2 text-sm font-medium text-white/58">
                <Landmark className="size-4 text-[#ffb4a6]" />
                Funding
              </p>
              <h3 className="mt-6 text-3xl font-[350] leading-tight text-white">
        ...
        <section className="bg-[#0b0b0b]">
          <div className="mx-auto grid max-w-[1180px] gap-8 px-4 py-16 md:grid-cols-[minmax(0,1fr)_auto] md:items-center md:py-20">
            <div>
              <p className="text-xs font-medium uppercase text-[#e01616]">Advertise on UBEYE</p>
              <h2 className="mt-4 max-w-3xl text-4xl font-[350] leading-tight text-white md:text-5xl">
